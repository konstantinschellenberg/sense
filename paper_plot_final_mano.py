            ...
            for kkk in opt_mod:
                ...
                if kkk == 'time_invariant':
                    ...
                    if canopy == 'turbid_isotropic':
                        if surface == 'WaterCloud':
                            var_opt = ['coef', 'C_vv', 'D_vv']
                            guess = [0.5, C_vv, D_vv]
                            bounds = [(0.00005,10), (-5,-20), (5,20)]
                        if surface == 'Oh92' or surface == 'Oh04' or surface == 'Dubois95':
                            var_opt = ['coef', 's']
                            guess = [0.5, s]
                            bounds = [(0.00005,10), (0.001, 0.03)]
                        if surface == 'I2EM':
                            var_opt = ['coef', 's', 'l']
                            guess = [0.5, s, l]
                            bounds = [(0.00005,10), (0.001, 0.03), (0.001, 0.1)]
                ...
                if canopy == 'turbid_isotropic':
                    if kkk == 'time_variant':
                        ...
                        if surface == 'Oh92' or surface == 'Oh04' or surface == 'Dubois95':
                            df_output[k,kk,kkk,field,'coef'] = aaa[0]
                            coef = aaa[0]
                            df_output[k,kk,kkk,field,'s'] = aaa[1]
                            s = aaa[1]
                        if surface == 'I2EM':
                            df_output[k,kk,kkk,field,'coef'] = aaa[0]
                            coef = aaa[0]
                            df_output[k,kk,kkk,field,'s'] = aaa[1]
                            s = aaa[1]
                            df_output[k,kk,kkk,field,'l'] = aaa[2]
                            l = aaa[2]
                ...
                if canopy == 'turbid_isotropic':
                    if surface == 'WaterCloud':
                        vv_model, vh_model = run([np.array(df_output[k, kk, kkk, field, 'coef']),np.array(df_output[k, kk, kkk, field, 'C_vv']),np.array(df_output[k, kk, kkk, field, 'D_vv'])])
                    if surface == 'Oh92' or surface == 'Oh04' or surface == 'Dubois95':
                        vv_model, vh_model = run([np.array(df_output[k, kk, kkk, field, 'coef']),np.array(df_output[k, kk, kkk, field, 's'])])
                    if surface == 'I2EM':
                        vv_model, vh_model = run([np.array(df_output[k, kk, kkk, field, 'coef']),np.array(df_output[k, kk, kkk, field, 's'].mean()),np.array(df_output[k, kk, kkk, field, 'l'].mean())])
